...
from acidano.data_processing.load_data import load_data_tvt
from acidano.models.CRBM.class_def import CRBM
...
def train(params, dataset, temporal_granularity, log_file_path):
    ...
    with open(log_file_path, 'ab') as log_file:
        ...
        log_file.write((u'# learning_rate :  {}\n'.format(learning_rate)).encode('utf8'))
    ...
    with open(log_file_path, 'ab') as log_file:
        log_file.write((u'# n_train_batch :  {}\n'.format(n_train_batches)).encode('utf8'))
        log_file.write((u'# n_val_batch :  {}\n'.format(n_val_batches)).encode('utf8'))
    print((u'# n_train_batch :  {}'.format(n_train_batches)).encode('utf8'))
    print((u'# n_val_batch :  {}'.format(n_val_batches)).encode('utf8'))
