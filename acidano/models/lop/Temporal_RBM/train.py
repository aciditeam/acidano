...
from acidano.models.lop.Temporal_RBM.class_def import RBM_temporal_bin


# Define hyper-parameter search space
def get_header():
    return ['temporal_order', 'n_hidden', 'batch_size', 'accuracy']
...
def train(params, dataset, temporal_granularity, log_file_path):
    ...
    optimizer = {'name': 'adam_l2',
                 ...
                 'beta1': 0.9,
                 'beta2': 0.999}
    # optimizer = {'name': 'gradient_descent',
    #              'lr': 0.05}
    ...
    cost, updates = rbm.cost_updates(k=10)
