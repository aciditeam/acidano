...
<!-- D3.js -->
<script src="/home/aciditeam-leo/Aciditeam/acidano/acidano/visualization/d3.v3.min.js" charset="utf-8"></script>
...
<script>
    ...
    d3.csv(filename, type, function(data) {
        ...
        // Draw lines
        var linesAttr = {
            x1: function(d){return W(d.x);},
            y1: function(d){return H(0);},
            x2: function(d){return W(d.x);},
            y2: function(d){return H(d.y);},
            style: "stroke:#4370b7;stroke-width:2;opacity:0.1"
        };
